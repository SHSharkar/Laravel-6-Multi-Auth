...
class MultiAuthInstallCommand extends InstallAndReplaceCommand
{
     ...
     * @var string
     */
    protected $description = 'Install Laravel 6 Multi Authentication';
